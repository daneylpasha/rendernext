        ...
        {!isOpen && (
          ...
          >
            ...
            <span
              ...
              style={{ background: "rgba(245,166,35,0.35)", transform: "scale(1.3)" }}
            />
            <span
              ...
              style={{
                ...
                boxShadow: "0 0 18px rgba(245,166,35,0.18), 0 8px 24px rgba(0,0,0,0.45)",
              }}
            >
              <Headset className="w-5 h-5 text-[#F5A623]" />
            </span>
            <span
