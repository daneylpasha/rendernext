...
import { Container, DecorativeRing } from "@/components/ui";
...
export function CTA() {
  ...
  return (
    <section
      ref={sectionRef}
      id="cta"
      className="bg-[#141414] py-20 lg:py-32 relative"
    >
      ...
      <Container className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            <div className="rounded-2xl p-8 lg:p-10 relative"
              style={{
            ...
            >
              {/* Top accent line */}
              <div className="absolute top-0 left-8 right-8 h-px bg-gradient-to-r from-transparent via-[#F5A623]/40 to-transparent" />
              ...
              {isSubmitted ? (
                ...
                <>
                  {/* Form Header */}
                  <div className="mb-8">
                    <h3 className="font-heading text-xl lg:text-2xl font-bold text-white leading-tight tracking-tight mb-2">
                      Get a Free Quote
                    </h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full h-12 px-4 rounded-xl text-base text-white placeholder:text-white/25
                          bg-white/[0.07] border transition-all duration-200 outline-none
                          focus:bg-white/[0.10] focus:border-[#F5A623]/70
                          ${errors.name ? "border-red-500/60" : "border-white/[0.12]"}`}
                      />
                      {errors.name && (
                    ...
                    {/* Email Field */}
                    <div>
                      <label htmlFor="cta-email" className="block text-xs font-semibold text-white/60 uppercase tracking-wider mb-1.5">
                      ...
                      <input
                        ...
                        className={`w-full h-12 px-4 rounded-xl text-base text-white placeholder:text-white/25
                          bg-white/[0.07] border transition-all duration-200 outline-none
                          focus:bg-white/[0.10] focus:border-[#F5A623]/70
                          ${errors.email ? "border-red-500/60" : "border-white/[0.12]"}`}
                      />
                      {errors.email && (
                      ...
                      <div className="flex gap-2">
                        ...
                        <div className="relative" ref={countryDropdownRef}>
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 h-12 rounded-xl min-w-[90px]
                              bg-white/[0.07] border border-white/[0.12] text-white
                              hover:bg-white/[0.10] hover:border-[#F5A623]/50
                              ...
                              <div className="p-2 border-b border-white/[0.08]">
                                <div className="relative">
                                  ...
                                  <input
                                    ...
                                    className="w-full pl-9 pr-3 py-2 text-sm text-white bg-white/[0.07] border border-white/[0.10] rounded-lg
                                      outline-none focus:border-[#F5A623]/60 transition-colors placeholder:text-white/25"
                        ...
                        <input
                          ...
                          onChange={handleChange}
                          className="flex-1 h-12 px-4 rounded-xl text-base text-white placeholder:text-white/25
                            bg-white/[0.07] border border-white/[0.12] transition-all duration-200 outline-none
                            focus:bg-white/[0.10] focus:border-[#F5A623]/70"
                        />
                      </div>
                    </div>
                    ...
                    {/* Budget Field */}
                    <div>
                      <label htmlFor="cta-budget" className="block text-xs font-semibold text-white/60 uppercase tracking-wider mb-1.5">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className={`w-full px-4 h-12 rounded-xl text-base transition-all duration-200 outline-none
                          bg-white/[0.07] border focus:bg-white/[0.10] focus:border-[#F5A623]/70
                          ${errors.budget ? "border-red-500/60" : "border-white/[0.12]"}
                          ${!formData.budget ? "text-white/25" : "text-white"}`}
                      ...
                      >
                        {budgetOptions.map((option) => (
                          <option
                            ...
                            style={{ background: "#1a1a1a", color: option.disabled ? "rgba(255,255,255,0.3)" : "#fff" }}
                          >
                            {option.label}
                          </option>
                        ))}
                    ...
                    <button
                      ...
                      className="w-full text-[#141414] font-bold px-8 py-4 rounded-xl text-base
